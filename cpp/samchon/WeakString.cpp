...
auto WeakString::finds(const std::vector<std::string> &delims, size_t startIndex) const -> IndexPair<WeakString>
{
...
/* --------------------------------------------------------------------
	REPLACERS
-------------------------------------------------------------------- */
auto WeakString::replace(const WeakString &before, const WeakString &after) const -> std::string
{
