...
namespace protocol
{
	...
	public:
		 ...
		 * of XML objects representing children are done by abstract method of EntityList::to_XML(). </p>
		 *
		 ...
		 *
		 * <p> Do not consider about archiving children Entity objects' data in EntityList::to_XML().
