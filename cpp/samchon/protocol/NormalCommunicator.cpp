...
NormalCommunicator::NormalCommunicator()
{
}
NormalCommunicator::~NormalCommunicator()
{
...
void NormalCommunicator::listen()
{
...
auto NormalCommunicator::listen_string(size_t size) -> shared_ptr<Invoke>
{
	///////
	// READ CONTENT
	///////
...
void NormalCommunicator::listen_binary(size_t size, shared_ptr<Invoke> &invoke)
{
...
void NormalCommunicator::sendData(shared_ptr<Invoke> invoke)
{
	// SEND INVOKE
