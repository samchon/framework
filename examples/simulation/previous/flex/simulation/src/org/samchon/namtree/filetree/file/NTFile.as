package org.samchon.namtree.filetree.file
{
	...
	public class NTFile extends FTFile
	{
		...
		//public function NTFile(fileList:FTFileList, fileID:int, parentID:int, name:String, header:String = "", getFunction:String = "", composerFunction:String = "", returnType:String = "Number", otherside:int = int.MIN_VALUE)
		//{
