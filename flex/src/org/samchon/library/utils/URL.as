package org.samchon.library.utils
{
	...
	/**
	 * URL is a utility class gathering interaction functions with web (browser-side containing Flex SWF file).<br>
	 * <br>
	...
	{
		/**
		 * Get the URL which is containing Flex swf file<br>
		...
		/**
		 * Get the URLVariables (GET method) from URL<br>
		 * ex) http://samchon.org/simulation/index.html?movie=montecarlo&type=4&code=005930<br>
		...
		/**
		 * Flash's original navigateToURL does not act in Internet Explorer<br>
		 * Instaned, URL::navigateToURL calls the javascript's window.open
		 */
