            ...
            var DistributedSystem = (function (_super) {
                ...
                DistributedSystem.prototype._Compute_average_elapsed_time = function () {
                    ...
                    for (var it = this.history_list_.begin(); !it.equals(this.history_list_.end()); it = it.next()) {
                        var history_2 = it.second;
                        if (history_2 instanceof distributed.DSInvokeHistory == false)
                            continue;
                        var elapsed_time = history_2.computeElapsedTime() / history_2.getWeight();
                        sum += elapsed_time / history_2.getProcess().getResource();
                        denominator++;
                    }
                    if (denominator == 0)
                        return -1;
            ...
            var DistributedProcess = (function (_super) {
                ...
                DistributedProcess.prototype._Compute_average_elapsed_time = function () {
                    ...
                    for (var it = this.history_list_.begin(); !it.equals(this.history_list_.end()); it = it.next()) {
                        ...
                        sum += elapsed_time * history_3.getSystem().getPerformance();
                    }
...
/// <reference path="ExternalClientArray.ts" />
var samchon;
(function (samchon) {
    var templates;
    (function (templates) {
