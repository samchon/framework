var __extends=this&&this.__extends||function(t,e){function n(){this.constructor=t}for(var r in e)e.hasOwnProperty(r)&&(t[r]=e[r])
t.prototype=null===e?Object.create(e):(n.prototype=e.prototype,new n)},samchon
!function(t){function e(){return"object"==typeof process&&"object"==typeof process.versions&&"undefined"!=typeof process.versions.node}t.is_node=e}(samchon||(samchon={}))
...
!function(t){var e
!function(e){var n=function(n){function r(){var e=n.apply(this,arguments)||this
...
var r=n.prototype.push.apply(this,t)
return this._Notify_insert(this.end().advance(-t.length),this.end()),r},r.prototype.push_back=function(t){n.prototype.push_back.call(this,t),this._Notify_insert(this.end().prev(),this.end())},r.prototype._Insert_by_repeating_val=function(t,e,r){var o=n.prototype._Insert_by_repeating_val.call(this,t,e,r)
return this._Notify_insert(o,o.advance(e)),o},r.prototype._Insert_by_range=function(t,e,r){var o=this.size(),i=n.prototype._Insert_by_range.call(this,t,e,r)
...
return"erase"==e&&(n instanceof std.VectorIterator||n instanceof std.DequeIterator)?(o.temporary_container_=new std.Vector(n,r),o.origin_first_=n,o.first_=o.temporary_container_.begin(),o.last_=o.temporary_container_.end()):(o.temporary_container_=null,o.origin_first_=null,o.first_=n,o.last_=r),o}return __extends(e,t),Object.defineProperty(e.prototype,"target",{get:function(){return this.target_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"first",{get:function(){return this.first_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"last",{get:function(){return this.last_},enumerable:!0,configurable:!0}),e.prototype.preventDefault=function(){if(0!=this.cancelable){if(this.defaultPrevented_=!0,"insert"==this.type)this.target.erase(this.first_,this.last_)
...
return e.event_dispatcher_=new t.library.EventDispatcher(e),e}return __extends(r,n),r.prototype.push=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
var r=n.prototype.push.apply(this,t)
return this._Notify_insert(this.end().advance(-t.length),this.end()),r},r.prototype.push_back=function(t){n.prototype.push.call(this,t),this._Notify_insert(this.end().prev(),this.end())},r.prototype._Insert_by_repeating_val=function(t,e,r){var o=n.prototype._Insert_by_repeating_val.call(this,t,e,r)
return this._Notify_insert(o,o.advance(e)),o},r.prototype._Insert_by_range=function(t,e,r){var o=this.size(),i=n.prototype._Insert_by_range.call(this,t,e,r)
...
var r,o
0==t.length?(r=this.begin(),o=this.end()):1==t.length?(r=t[0],o=r.next()):(r=t[0],o=t[1]),this.dispatchEvent(new e.MapCollectionEvent("refresh",r,o))},r.prototype.addEventListener=function(t,e,n){void 0===n&&(n=null),this.event_dispatcher_.addEventListener(t,e,n)},r.prototype.removeEventListener=function(t,e,n){void 0===n&&(n=null),this.event_dispatcher_.removeEventListener(t,e,n)},r}(std.HashMap)
...
return e.event_dispatcher_=new t.library.EventDispatcher(e),e}return __extends(r,n),r.prototype.push=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
var r=n.prototype.push.apply(this,t)
return this._Notify_insert(this.end().advance(-t.length),this.end()),r},r.prototype._Insert_by_repeating_val=function(t,e,r){var o=n.prototype._Insert_by_repeating_val.call(this,t,e,r)
return this._Notify_insert(o,o.advance(e)),o},r.prototype._Insert_by_range=function(t,e,r){var o=this.size(),i=n.prototype._Insert_by_range.call(this,t,e,r)
...
var samchon
!function(t){var e
!function(t){var e=function(t){function e(){return t.apply(this,arguments)||this}return __extends(e,t),Object.defineProperty(e.prototype,"first",{get:function(){return this.first_},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"last",{get:function(){return this.last_},enumerable:!0,configurable:!0}),e}(t.CollectionEvent)
...
var samchon
!function(t){var e
!function(t){var e=function(){function t(t,e){this.n_=t,this.r_=e}return t.prototype.size=function(){return this.size_},t.prototype.n=function(){return this.n_},t.prototype.r=function(){return this.r_},t}()
t.CaseGenerator=e
var n=function(t){function e(e,n){var r=t.call(this,e,n)||this
r.size_=Math.pow(e,n),r.divider_array=new Array
for(var o=0;o<n;o++){var i=n-(o+1),s=Math.pow(e,i)
r.divider_array.push(s)}return r}return __extends(e,t),e.prototype.at=function(t){for(var e=[],n=0;n<this.r_;n++){var r=Math.floor(t/this.divider_array[n])%this.n_
e.push(r)}return e},e}(e)
t.CombinedPermutationGenerator=n
var r=function(t){function e(e,n){var r=t.call(this,e,n)||this
r.size_=e
for(var o=e-1;o>e-n;o--)r.size_*=o
return r}return __extends(e,t),e.prototype.at=function(t){for(var e=[],n=0;n<this.n_;n++)e.push(n)
for(var r=[],n=0;n<this.r_;n++){var o=t%e.length
t=Math.floor(t/e.length),r.push(e[o]),e.splice(o,1)}return r},e}(e)
t.PermuationGenerator=r
var o=function(t){function e(e){return t.call(this,e,e)||this}return __extends(e,t),e}(r)
t.FactorialGenerator=o}(e=t.library||(t.library={}))}(samchon||(samchon={}))
var samchon
!function(t){var e
...
var samchon
!function(samchon){var library
!function(library){var GeneticAlgorithm=function(){function t(t,e,n){void 0===t&&(t=!0),void 0===e&&(e=.015),void 0===n&&(n=10),this.unique_=t,this.mutation_rate_=e,this.tournament_=n}return t.prototype.evolveGeneArray=function(t,e,n,r){void 0===r&&(r=std.greater)
for(var o=new GAPopulation(t,e),i=0;i<n;i++)o=this.evolvePopulation(o)
return o.fitTest()},t.prototype.evolvePopulation=function(t,e){void 0===e&&(e=std.greater)
var n=t.children().size(),r=new GAPopulation(n)
r.children().set(0,t.fitTest())
for(var o=1;o<n;o++){var i=this.selection(t),s=this.selection(t),a=this.crossover(i,s)
this.mutate(a),r.children().set(o,a)}return r},t.prototype.selection=function(t){for(var e=t.children().size(),n=new GAPopulation(e),r=0;r<e;r++){var o=Math.floor(Math.random()*e)
o==e&&o--,n.children().set(r,t.children().at(o))}return n.fitTest()},t.prototype.crossover=function(t,e){var n=t.constructor(t),r=t.size()
if(0==this.unique_)for(var o=0;o<r;o++)Math.random()>.5&&n.set(o,t.at(o))
else{var i=new std.HashSet,s=new std.HashSet,a=Math.random()*r,c=Math.random()*r
a>c&&(h=[c,a],a=h[0],c=h[1])
for(var o=0;o<r;o++)a<=o&&o<c?i.insert(t.at(o)):s.insert(o)
for(var o=0;o<r;o++){var u=e.at(o)
0!=i.find(u).equals(i.end())&&(n.set(s.begin().value,u),s.erase(s.begin()))}}return n
var h},t.prototype.mutate=function(t){for(var e=t.begin();!e.equals(t.end());e=e.next())if(!(Math.random()>this.mutation_rate_)){var n=Math.floor(Math.random()*t.size())
e.swap(t.begin().advance(n))}},t}()
library.GeneticAlgorithm=GeneticAlgorithm
var GAPopulation=function(){function GAPopulation(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
if(1==t.length)this.children_=new std.Vector
else{var n=t[0],r=t[1],o=2==t.length?std.greater:t[2]
this.children_=new std.Vector,this.compare_=o
for(var i=0;i<r;i++){var s=this.clone(n)
i>0&&std.random_shuffle(s.begin(),s.end()),this.children_.push_back(s)}}}return GAPopulation.prototype.children=function(){return this.children_},GAPopulation.prototype.fitTest=function(){for(var t=this.children_.front(),e=1;e<this.children_.size();e++)1==this.compare_(this.children_.at(e),t)&&(t=this.children_.at(e))
return t},GAPopulation.prototype.clone=function(obj){var ret=eval("new obj.constructor()")
for(var key in obj)1==obj.hasOwnProperty(key)&&(ret[key]=obj[key])
return ret},GAPopulation}()
library.GAPopulation=GAPopulation}(library=samchon.library||(samchon.library={}))}(samchon||(samchon={}))
var samchon
!function(t){var e
!function(t){var e=function(){function t(){}return t.between=function(t,e,n){if(void 0===e&&(e=""),void 0===n&&(n=""),""==e&&""==n)return t
if(""==e)return t.substr(0,t.indexOf(n))
if(""==n)return t.substr(t.indexOf(e)+e.length)
var r=t.indexOf(e)
return r==-1?"":t.substring(r+e.length,t.indexOf(n,r+e.length))},t.betweens=function(e,n,r){void 0===n&&(n=""),void 0===r&&(r="")
var o=[]
if(""==n&&""==r)return[e]
if(n==r)for(var i=-1,s=void 0,a=0;(s=e.indexOf(n,i+1))!=-1;)++a%2==0&&o.push(e.substring(i,s)),s=i
else if(o=e.split(n).splice(1),""!=r)for(var c=o.length-1;c>=0;c--)o[c].indexOf(r)==-1?o.splice(c,1):o[c]=t.between(o[c],"",r)
return o},t.trim=function(e){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r]
return 0==n.length&&(n=t.SPACE_ARRAY),t.ltrim.apply(t,[t.rtrim.apply(t,[e].concat(n))].concat(n))},t.ltrim=function(e){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r]
0==n.length&&(n=t.SPACE_ARRAY)
for(var o=0;o<e.length;){for(var i=o,s=0;s<n.length;s++){var a=e.indexOf(n[s],i)+n[s].length
i=Math.max(i,a)}if(i<=o)break
o=i}return o==e.length?"":e.substr(o)},t.rtrim=function(e){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r]
0==n.length&&(n=t.SPACE_ARRAY)
for(var o=e.length;0!=o;){for(var i=o,s=0;s<n.length;s++){var a=e.lastIndexOf(n[s],i-1)
a!=-1&&(i=Math.min(i,a))}if(i==-1||i>=o)break
o=i}return e.substr(0,o)},t.substitute=function(e){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r]
for(;;){if(0==n.length)break
for(var o=t.betweens(e,"{","}"),i=Number.MAX_VALUE,s=0;s<o.length;s++){var a=Number(o[s])
1!=isNaN(a)&&(i=Math.min(i,a))}if(i==Number.MAX_VALUE)break
e=t.replaceAll(e,"{"+i+"}",n[0]),n.shift()}return e},t.replaceAll=function(t){for(var e=[],n=1;n<arguments.length;n++)e[n-1]=arguments[n]
...
t=t.split(s.first).join(s.second)}return t},t.removeHTMLSpaces=function(e){return t.replaceAll(e,new std.Pair("&nbsp;"," "),new std.Pair("\t"," "),new std.Pair("  "," "))},t.repeat=function(t,e){for(var n="",r=0;r<e;r++)n+=t
return n},t.numberFormat=function(e,n){void 0===n&&(n=2)
var r=""
e=Math.round(e*Math.pow(10,n)),e/=Math.pow(10,n)
var o=e<0,i=Math.floor(Math.abs(e)),s=Math.abs(e)-Math.floor(Math.abs(e))
if(0==i)r="0"
else for(var a=Math.floor(Math.log(i)/Math.log(10))+1,c=0;c<=a;c++){var u=Math.floor(i%Math.pow(10,c+1))
u=Math.floor(u/Math.pow(10,c)),c==a&&0==u||(c>0&&c%3==0&&(r=","+r),r=u+r)}if(1==o&&(r="-"+r),n>0&&0!=s){s=Math.round(s*Math.pow(10,n))
var h=n-Math.floor(Math.log(s)/Math.log(10))-1
r+="."+t.repeat("0",h)+s}return r},t.percentFormat=function(e,n){return void 0===n&&(n=2),t.numberFormat(100*e,n)+" %"},t}()
...
r==-1?(o=e[n],i=""):(o=e[n].substr(0,r),i=decodeURIComponent(e[n].substr(r+1))),this.insert([o,i])}}},e.prototype.toString=function(){for(var t="",e=this.begin();!e.equals(this.end());e=e.next())e.equals(this.begin())||(t+="&"),t+=e.first+"="+encodeURIComponent(e.second)
...
if(r.indexOf("=")!=-1){for(var o,i,s,a,c=[],u=!1,h=0;h<r.length;h++)0!=u||"'"!=r.charAt(h)&&'"'!=r.charAt(h)?1==u&&(1==s&&"'"==r.charAt(h)||2==s&&'"'==r.charAt(h))&&(c.push({type:s,start:e,end:h}),u=!1):(u=!0,e=h,"'"==r.charAt(h)?s=1:'"'==r.charAt(h)&&(s=2))
for(var h=0;h<c.length;h++){c[h]
0==h?(a=r.indexOf("="),o=r.substring(0,a).trim()):(a=r.indexOf("=",c[h-1].end+1),o=r.substring(c[h-1].end+1,a).trim()),i=r.substring(c[h].start+1,c[h].end),this.setProperty(o,this._Decode_property(i))}}}},n.prototype._Parse_value=function(t){var e=t.lastIndexOf("/"),n=t.indexOf(">")
...
var c=void 0,u=new n
u._Parse(e.substring(r,o+1)),1==this.has(u.tag_)?c=this.get(u.tag_):(c=new t.XMLList,this.set(u.tag_,c)),c.push(u),a=o,r=o+1,i=0,s=0}}},n.prototype.getTag=function(){return this.tag_},n.prototype.getValue=function(){return this.value_},n.prototype.findProperty=function(t){return this.property_map_.find(t)},n.prototype.hasProperty=function(t){return this.property_map_.has(t)},n.prototype.getProperty=function(t){return this.property_map_.get(t)},n.prototype.getPropertyMap=function(){return this.property_map_},n.prototype.setTag=function(t){this.tag_=t},n.prototype.setValue=function(t){this.value_=t},n.prototype.setProperty=function(t,e){this.property_map_.set(t,e)},n.prototype.eraseProperty=function(t){var e=this.property_map_.find(t)
...
return t.StringUtil.replaceAll.apply(t.StringUtil,[e].concat(n))},n.prototype._Encode_value=function(e){var n=[new std.Pair("&","&amp;"),new std.Pair("<","&lt;"),new std.Pair(">","&gt;")]
return t.StringUtil.replaceAll.apply(t.StringUtil,[e].concat(n))},n.prototype._Decode_property=function(e){var n=[new std.Pair("&amp;","&"),new std.Pair("&lt;","<"),new std.Pair("&gt;",">"),new std.Pair("&quot;",'"'),new std.Pair("&apos;","'"),new std.Pair("&#x9;","\t"),new std.Pair("&#xA;","\n"),new std.Pair("&#xD;","\r")]
return t.StringUtil.replaceAll.apply(t.StringUtil,[e].concat(n))},n.prototype._Encode_property=function(e){var n=[new std.Pair("&","&amp;"),new std.Pair("<","&lt;"),new std.Pair(">","&gt;"),new std.Pair('"',"&quot;"),new std.Pair("'","&apos;"),new std.Pair("\t","&#x9;"),new std.Pair("\n","&#xA;"),new std.Pair("\r","&#xD;")]
return t.StringUtil.replaceAll.apply(t.StringUtil,[e].concat(n))},n.prototype.toString=function(e){void 0===e&&(e=0)
...
t.XML=e}(e=t.library||(t.library={}))}(samchon||(samchon={})),function(t){var e
!function(t){var e=function(t){function e(){return t.apply(this,arguments)||this}return __extends(e,t),e.prototype.getTag=function(){return this.front().getTag()},e.prototype.toString=function(t){void 0===t&&(t=0)
...
break}1!=s&&("string"==typeof t[i.first]?t[i.first]=i.second:"number"==typeof t[i.first]?t[i.first]=Number(i.second):"boolean"==typeof t[i.first]&&(t[i.first]="true"==i.second))}}function r(e){for(var n=[],r=1;r<arguments.length;r++)n[r-1]=arguments[r]
...
for(var c=0;c<s.size();c++){var u=s.at(c),h=c==s.size()-1?i-n:Math.floor(i/s.size()*u.getPerformance())
0!=h&&(u._Send_piece_data(e,n,n+h),n+=h,a++)}return a},r.prototype._Complete_history=function(t){if(t instanceof n.PRInvokeHistory==0)return!1
...
if(1!=s.enforced_){var u=o.at(r).second/i,h=void 0
h=s.history_list_.size()<2?.3:Math.min(.7,1/(s.history_list_.size()-1)),s.setPerformance(s.getPerformance()*h+u*(1-h))}}return this._Normalize_performance(),!0},r.prototype._Normalize_performance=function(){for(var t=0,e=0,n=0;n<this.size();n++){var r=this.at(n)
...
var a=t.computeElapsedTime()/t.getWeight(),c=n/a,u=void 0
u=e.history_list_.size()<2?.3:Math.min(.7,1/(e.history_list_.size()-1)),e.setPerformance(e.getPerformance()*u+c*(1-u))}}},r.prototype._Normalize_performance=function(){e.prototype._Normalize_performance.call(this)
...
var samchon
!function(t){var e
!function(t){var e=function(t){function e(){var e=t.apply(this,arguments)||this
...
var samchon
!function(t){var e
!function(t){var e=function(t){function e(){return t.apply(this,arguments)||this}return __extends(e,t),e.prototype._Handle_message=function(t){0==this._Is_binary_invoke()?this._Handle_string(t.data):this._Handle_binary(t.data)},e}(t._CommunicatorBase)
...
var samchon
!function(t){var e
!function(t){var e=function(t){function e(){return t.apply(this,arguments)||this}return __extends(e,t),e.prototype.close=function(){this.connected_=!1,this.port_.close(),null!=this.onClose&&this.onClose()},e.prototype.sendData=function(t){this.port_.postMessage(t.toXML().toString())
...
var samchon
!function(t){var e
!function(e){var n=function(e){function n(t){var n=e.call(this,t)||this
return n.browser_socket_=null,n.node_client_=null,n.connected_=!1,n.onConnect=null,n}return __extends(n,e),n.prototype.connect=function(e,n,r){void 0===r&&(r="")
var o
if(e.indexOf("ws://")==-1){if(e.indexOf("://")!=-1)throw"only websocket is possible"
e="ws://"+e}o=e+":"+n+"/"+r,1==t.is_node()?(this.node_client_=new websocket.client,this.node_client_.on("connect",this._Handle_node_connect.bind(this)),this.node_client_.connect(o)):(this.browser_socket_=new WebSocket(o),this.browser_socket_.onopen=this._Handle_browser_connect.bind(this),this.browser_socket_.onerror=this.handle_close.bind(this),this.browser_socket_.onclose=this.handle_close.bind(this),this.browser_socket_.onmessage=this._Handle_browser_message.bind(this))},n.prototype.close=function(){1==t.is_node()?e.prototype.close.call(this):this.browser_socket_.close()},n.prototype.sendData=function(t){if(null!=this.browser_socket_){this.browser_socket_.send(t.toXML().toString())
for(var n=0;n<t.size();n++)"ByteArray"==t.at(n).getType()&&this.browser_socket_.send(t.at(n).getValue())}else e.prototype.sendData.call(this,t)},n.prototype._Handle_browser_connect=function(t){this.connected_=!0,null!=this.onConnect&&this.onConnect()},n.prototype._Handle_browser_message=function(t){0==this._Is_binary_invoke()?this._Handle_string(t.data):this._Handle_binary(t.data)},n.prototype._Handle_node_connect=function(t){this.connected_=!0,this.connection_=t,this.connection_.on("message",this.handle_message.bind(this)),this.connection_.on("close",this.handle_close.bind(this)),this.connection_.on("error",this.handle_close.bind(this)),null!=this.onConnect&&this.onConnect()},n}(e.WebCommunicator)
e.WebServerConnector=n}(e=t.protocol||(t.protocol={}))}(samchon||(samchon={}))
var samchon
!function(t){var e
!function(t){var e
!function(e){function n(e,n){for(var r=[],o=2;o<arguments.length;o++)r[o-2]=arguments[o]
if(e.clear(),t.IEntity.construct.apply(t.IEntity,[e,n].concat(r)),0!=n.has(e.CHILD_TAG())){for(var i=new std.Vector,s=n.get(e.CHILD_TAG()),a=0;a<s.size();a++){var c=e.createChild(s.at(a))
...
for(var o=t.IEntity.toXML.apply(t.IEntity,[e].concat(n)),i=e.begin();!i.equals(e.end());i=i.next())o.push(i.value.toXML())
...
!function(t){var e=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.construct=function(e){t.IEntityGroup.construct(this,e)},n.prototype.key=function(){return""},n.prototype.has=function(e){return t.IEntityGroup.has(this,e)},n.prototype.count=function(e){return t.IEntityGroup.count(this,e)},n.prototype.get=function(e){return t.IEntityGroup.get(this,e)},n.prototype.toXML=function(){return t.IEntityGroup.toXML(this,"length")},n}(std.Vector)
t.EntityArray=e}(e=t.protocol||(t.protocol={}))}(samchon||(samchon={})),function(t){var e
!function(t){var e=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.construct=function(e){t.IEntityGroup.construct(this,e)},n.prototype.key=function(){return""},n.prototype.has=function(e){return t.IEntityGroup.has(this,e)},n.prototype.count=function(e){return t.IEntityGroup.count(this,e)},n.prototype.get=function(e){return t.IEntityGroup.get(this,e)},n.prototype.toXML=function(){return t.IEntityGroup.toXML(this)},n}(std.List)
t.EntityList=e}(e=t.protocol||(t.protocol={}))}(samchon||(samchon={})),function(t){var e
!function(t){var e=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.construct=function(e){t.IEntityGroup.construct(this,e)},n.prototype.key=function(){return""},n.prototype.has=function(e){return t.IEntityGroup.has(this,e)},n.prototype.count=function(e){return t.IEntityGroup.count(this,e)},n.prototype.get=function(e){return t.IEntityGroup.get(this,e)},n.prototype.toXML=function(){return t.IEntityGroup.toXML(this)},n}(std.Deque)
...
return r.name="",r.type="",r.value=null,0==t.length?r:(1==t.length?(r.name="",r.setValue(t[0])):(r.name=t[0],r.setValue(t[1])),r)}return __extends(n,e),n.prototype.construct=function(t){this.name=t.hasProperty("name")?t.getProperty("name"):"",this.type=t.getProperty("type"),"XML"==this.type?this.value=t.begin().second.front():"boolean"==this.type?this.value=Boolean(t.getValue()):"number"==this.type?this.value=Number(t.getValue()):"string"==this.type&&(this.value=t.getValue())},n.prototype.setValue=function(e){this.value=e,e instanceof t.library.XML?this.type="XML":e instanceof Uint8Array?this.type="ByteArray":this.type=typeof e},n.prototype.key=function(){return this.name},n.prototype.getName=function(){return this.name},n.prototype.getType=function(){return this.type},n.prototype.getValue=function(){return this.value},n.prototype.TAG=function(){return"parameter"},n.prototype.toXML=function(){var e=new t.library.XML
...
e.on("request",this._Handle_request.bind(this))},e.prototype.close=function(){this.http_server_.close()},e.prototype._Handle_request=function(e){var n=e.resource.substr(1),r=this._Fetch_session_id(e.cookies),o=e.accept("",e.origin,[{name:"SESSION_ID",value:r}]),i=new t.WebClientDriver(o,n,r)
...
this.progress_list_.insert([s.getUID(),std.make_pair(i,s)]),this.sendData(i)},r.prototype._Reply_data=function(t){if("_Report_history"==t.getListener())this._Report_history(t.front().getValue())
...
1!=o.equals(this.progress_list_.end())&&(r.process_=o.second.second.getProcess(),r.weight_=o.second.second.getWeight(),this.progress_list_.erase(o),this.history_list_.insert([r.getUID(),r]),null!=r.getProcess()&&r.getProcess()._Complete_history(r),this.getSystemArray()._Complete_history(r))},n.prototype._Send_back_history=function(n,r){r instanceof e.DSInvokeHistory&&r.getProcess().sendData(n,r.getWeight()),t.prototype._Send_back_history.call(this,n,r)},n}(t.parallel.ParallelSystem)
...
1!=a.exclude_&&(null==i||1==a.history_list_.empty()||a.progress_list_.size()<i.progress_list_.size()||a.progress_list_.size()==i.progress_list_.size()&&a.getPerformance()>i.getPerformance()||a.progress_list_.size()==i.progress_list_.size()&&a.getPerformance()==i.getPerformance()&&a.history_list_.size()<i.history_list_.size())&&(null!=i&&0!=i.history_list_.empty()||(i=a))}if(null==i)throw new std.OutOfRange("No remote system to send data")
var c=new e.DSInvokeHistory(i,this,n,r)
return this.progress_list_.insert([o,c]),i.progress_list_.insert([o,std.make_pair(n,c)]),i.sendData(n),i},r.prototype._Complete_history=function(t){this.progress_list_.erase(t.getUID()),this.history_list_.insert([t.getUID(),t])},r.prototype.TAG=function(){return"process"},r}(t.protocol.Entity)
...
!function(t){var e
!function(t){var e
!function(t){var e=function(){function e(){this.communicator_=null}return e.prototype.sendData=function(t){this.communicator_.sendData(t)},e.prototype._Reply_data=function(e){if(e.has("_History_uid")){var n=new t.InvokeHistory(e)
std.remove_if(e.begin(),e.end(),function(t){return"_History_uid"==t.getName()||"_Process_name"==t.getName()||"_Process_weight"==t.getName()})
var r=new t.PInvoke(e,n,this)
this.replyData(r),0==r.isHold()&&r.complete()}else this.replyData(e)},e.prototype.replyData=function(t){t.apply(this)},e}()
...
if(this.progress_list_.insert([r.getUID(),r]),1==n.has("_Piece_first")){var o=n.get("_Piece_first").getValue(),i=n.get("_Piece_last").getValue()
...
e.MediatorClient=n
var r=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.createServerConnector=function(){return new t.protocol.WebServerConnector(this)},n}(n)
e.MediatorWebClient=r
var o=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.createServerConnector=function(){return new t.protocol.SharedWorkerServerConnector(this)},n}(n)
...
e.MediatorServer=n
var r=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.createServerBase=function(){return new t.protocol.WebServerBase(this)},n}(n)
e.MediatorWebServer=r
var o=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.createServerBase=function(){return new t.protocol.DedicatedWorkerServerBase(this)},n}(n)
e.MediatorDedicatedWorkerServer=o
var i=function(e){function n(){return e.apply(this,arguments)||this}return __extends(n,e),n.prototype.createServerBase=function(){return new t.protocol.SharedWorkerServerBase(this)},n}(n)
...
return null==e?(n.first=0,n.last=0):(n.first=e.get("_Piece_first").getValue(),n.last=e.get("_Piece_last").getValue()),n}return __extends(e,t),e.prototype.getFirst=function(){return this.first},e.prototype.getLast=function(){return this.last},e.prototype.computeSize=function(){return this.last},e}(t.slave.InvokeHistory)
...
return o.assign(e.begin(),e.end()),o.history_=n,o.master_driver_=r,o.hold_=!1,o}return __extends(e,t),e.prototype.getHistory=function(){return this.history_},e.prototype.isHold=function(){return this.hold_},e.prototype.hold=function(){this.hold_=!0},e.prototype.complete=function(){this.history_.complete(),this.master_driver_.sendData(this.history_.toInvoke())},e}(t.protocol.Invoke)
