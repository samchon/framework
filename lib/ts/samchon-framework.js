...
(function (samchon) {
    ...
    (function (protocol) {
        var NormalClientDriver = (function (_super) {
            ...
            NormalClientDriver.prototype.close = function () {
            };
...
(function (samchon) {
    ...
    (function (protocol) {
        var NormalServerConnector = (function (_super) {
            ...
            NormalServerConnector.prototype.close = function () {
                this.close();
            };
...
(function (samchon) {
    ...
    (function (protocol) {
        ...
        var WebCommunicatorBase = (function () {
             ...
             */
            WebCommunicatorBase.prototype.close = function () {
...
(function (samchon) {
    ...
    (function (protocol) {
        var WebClientDriver = (function (_super) {
             ...
             * @inheritdoc
             */
            WebClientDriver.prototype.close = function () {
                this.base.close();
            };
            /**
             * Get requested path.
        ...
        var WebServerConnector = (function (_super) {
            ...
            WebServerConnector.prototype.sendData = function (invoke) {
                if (this.browser_socket != null) {
                    ...
                    this.node_base.sendData(invoke);
                }
            };
            ...
            WebServerConnector.prototype.handle_node_connect = function (connection) {
                this.node_base = new protocol.WebCommunicatorBase(this, connection);
                this.node_base.listen();
                if (this.onopen != null)
                    this.onopen();
            };
