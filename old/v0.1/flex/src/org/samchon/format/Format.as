package org.samchon.format
{
	...
	public class Format
	{
		...
		private static var isConstructed:Boolean = false;
		
		private static function construct():void {
			if(isConstructed == true)
				return;
			
			intFormatter.useThousandsSeparator = true;
			intFormatter.precision = 0;
		...
		*/
		...
		public static function numberFormat(value:Number, skipBillion:Boolean = true, onlyInt:Boolean = false, fractionalDigits:int = 2):String {
			...
			{
				doubleFormatter.precision = fractionalDigits;
		...
		==========================================================
		*/
		public static function colorIntFormat(value:Number, skipBillion:Boolean = true):String {
			return colorNumberFormat(value, skipBillion, true);
		}
		public static function colorIntPercentFormat(value:Number, skipBillion:Boolean = true):String {
