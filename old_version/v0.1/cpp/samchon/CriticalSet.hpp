...
namespace samchon
{
	...
	public:
		...
		CriticalSet(initializer_list<value_type> il, const key_compare& comp = key_compare(), const allocator_type& alloc = allocator_type())
		...
		auto insert(value_type&& val) -> pair<iterator, bool>
		{
			writeLock();
