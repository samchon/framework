package
{
	...
	public class URL
	{
		...
		public static const COMPANY:String = PHP + "company/";
		public static const COMPANY_LIST:String = COMPANY + "list.php";
		...
		public static const PRICE_DAILY:String = PRICE + "daily.php";
