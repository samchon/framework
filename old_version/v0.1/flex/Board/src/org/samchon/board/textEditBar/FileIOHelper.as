package org.samchon.board.textEditBar
{
	...
	import org.samchon.board.textEditBar.StatusPopup;
	...
	public class FileIOHelper
	{
		...
		static public function exportToHTML(activeFlow:TextFlow) : String
		{
			var format:String = TextConverter.TEXT_FIELD_HTML_FORMAT;
			//CONFIG::debug
			{	
				var originalSettings:Object = XML.settings();
				try
		...
		static public function exportToLayout(activeFlow:TextFlow) : String
		{
			var format:String = TextConverter.TEXT_LAYOUT_FORMAT;
			//CONFIG::debug
			{	
				var originalSettings:Object = XML.settings();
				try
		...
		static public function moveTextFlow(textFlow:TextFlow):TextFlow {
			var html:String = FileIOHelper.exportToHTML(textFlow);
