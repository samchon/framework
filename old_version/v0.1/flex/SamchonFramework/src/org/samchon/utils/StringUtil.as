package org.samchon.utils
{
	...
	public class StringUtil extends mx.utils.StringUtil
	{
		...
		*/
		...
		public static function int2th(val:int):String
		{
			var text:String = Format.intFormat(val);
			var lastInt:int = val % 10;
			
			if(lastInt == 1)		text += "st";
			else if(lastInt == 2)	text += "nd";
			else if(lastInt == 3)	text += "rd";
			else
				text += "th";
		...
		*/
		...
		public static function getTabbed(val:String, tabLength:int = 1):String
		{
			var i:int;
