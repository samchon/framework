	...
	extends InvokeHistory
{
	 ...
	 */
	public constructor(system: DistributedSystem, process: DistributedProcess, invoke: Invoke, weight: number);

	public constructor(system: DistributedSystem, process: DistributedProcess = null, invoke: Invoke = null, weight: number = 1)
	{
		super(invoke);
