	...
	extends ParallelSystem
{
	 ...
	 */
	public constructor(systemArray: DistributedSystemArray<DistributedSystem>, communicator: IClientDriver);

	public constructor(systemArray: DistributedSystemArray<DistributedSystem>, communicator: IClientDriver = null)
	{
	 ...
	 */
	public createChild(xml: XML): ExternalSystemRole
	{
		return null;
	}
