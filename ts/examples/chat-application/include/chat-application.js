...
(function (example) {
    ...
    (function (chat) {
        ...
        chat.SERVER_HOST = "127.0.0.1"; //"115.71.237.198";
    ...
    (function (chat) {
        var LoginApplication = (function (_super) {
            ...
            LoginApplication.prototype.render = function () {
                return React.createElement("table", null, React.createElement("tbody", null, React.createElement("tr", null, React.createElement("td", null, " ID "), React.createElement("td", null, " ", React.createElement("input", {id: "id_input", type: "input", defaultValue: "samchon"}), " "), React.createElement("td", {rowSpan: "2"}, React.createElement("button", {onClick: this.handle_login_click.bind(this), style: { height: 50 }}, "Log-in"))), React.createElement("tr", null, React.createElement("td", null, " Name "), React.createElement("td", null, " ", React.createElement("input", {id: "name_input", type: "input", defaultValue: "Samchon"}), " "))));
            };
