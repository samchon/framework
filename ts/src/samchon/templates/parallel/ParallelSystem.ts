...
namespace samchon.templates.parallel
{
		...
		extends external.ExternalSystem
	{
		 ...
		 * @hidden
		 */
		private progress_list_: std.HashMap<number, std.Pair<protocol.Invoke, slave.InvokeHistory>>;
		
		/**
		 * @hidden
		 */
		private history_list_: std.HashMap<number, slave.InvokeHistory>;
		...
		public constructor(systemArray: ParallelSystemArray<ParallelSystem>, communicator: protocol.IClientDriver = null)
		{
			...
			// HIDDEN MEMBERS
			this.progress_list_ = new std.HashMap<number, std.Pair<protocol.Invoke, slave.InvokeHistory>>();
			this.history_list_ = new std.HashMap<number, slave.InvokeHistory>();
