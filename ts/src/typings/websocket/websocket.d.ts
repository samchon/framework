...
declare namespace __websocket
{
    ...
    export class server extends NodeJS.events.EventEmitter {
    ...
    export class request extends NodeJS.events.EventEmitter {
    ...
    class connection extends NodeJS.events.EventEmitter {
    ...
    class client extends NodeJS.events.EventEmitter {
        protocols: string[];
        origin: string;
        url: NodeJS.url.Url;
        secure: boolean;
    ...
    class routerRequest extends NodeJS.events.EventEmitter {
    ...
    class router extends NodeJS.events.EventEmitter {
